...
beautiful.init("/home/zer0/.config/awesome/theme/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "vim", "www", "etc", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- switching tags with arrow keys
...
awful.util.spawn("setxkbmap -option grp:alt_shift_toggle -option caps:escape -layout us,ru")
